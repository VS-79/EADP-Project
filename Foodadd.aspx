<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Foodadd.aspx.cs" Inherits="EADP_Project.Foodadd" %>
        ...
        <div>
            <table class="w-100">
                ...
                <tr>
                    <td class="auto-style4">&nbsp;</td>
                    <td>
                        <asp:TextBox ID="TextBoxname" class="text-line" runat="server" Width="475px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="auto-style11">
                        <textarea name="content" id="content" rows="10" runat="server" class="form-control"></textarea>&nbsp;<asp:Label ID="Label12" runat="server" Text="Culinary Types"></asp:Label>
                        <br />
                        ...
                        <br />
                        <asp:TextBox ID="txtdeals" class="text-line" runat="server" Width="252px" OnTextChanged="txtdeals_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">&nbsp;</td>
